...
import classes.AnaliseLinear;
import java.awt.Color;

public final class AnaliseDCFrame extends javax.swing.JFrame {
    ...
    public AnaliseDCFrame(JFrame frame, float r1, float r2, float r3, float r4, float vcc, float q1) {
        initComponents();
        this.getContentPane().setBackground(new Color(240, 240, 240));
        this.setLocationRelativeTo(null);

        this.setMainFrame(frame); //aqui é só pra voltar no frame anterior
        this.setR1(r1);
        this.setR2(r2);
        this.setR3(r3);
        this.setR4(r4);
    ...
    public void analisarDC() {
        AnaliseLinear objDC = new AnaliseLinear();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sources/Classe A DC.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AnaliseDCFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AnaliseDCFrame().setVisible(true);
            }
        });
    }
