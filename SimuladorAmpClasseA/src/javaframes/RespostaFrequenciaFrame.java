 ...
 * @author dimitri
 */
public final class RespostaFrequenciaFrame extends javax.swing.JFrame {
    ...
    private AnaliseVetorial objAV;
    private float gm;
    private float[] rpi = new float[2];

    public RespostaFrequenciaFrame(JFrame frame, float vin, float rin, float r1, float r2, float r3, float r4, float rl, float q1, float c1, float c2, float c3, float ib) {
        initComponents();
        this.setLocationRelativeTo(null);

        //o objeto vai ser da classe toda
        this.objAV = new AnaliseVetorial();
    ...
    private void initComponents() {
        ...
        setTitle("Resposta em Frequência");
    ...
    private RespostaFrequenciaFrame() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RespostaFrequenciaFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RespostaFrequenciaFrame().setVisible(true);
            }
        });
    }
