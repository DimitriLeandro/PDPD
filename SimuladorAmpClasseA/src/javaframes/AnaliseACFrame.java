 ...
 * @author dimitri
 */
public final class AnaliseACFrame extends javax.swing.JFrame {
    ...
    public AnaliseACFrame(JFrame frame, float vin, float rin, float r1, float r2, float ib, float r3, float rl, float q1) {
        initComponents();
    ...
    public void analisarAC() {
        ...
        AnaliseLinear objAC = new AnaliseLinear();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sources/Classe A AC 2.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AnaliseACFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AnaliseACFrame().setVisible(true);
            }
        });
    }
